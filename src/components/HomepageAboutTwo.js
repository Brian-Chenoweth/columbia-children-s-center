  ...
  return (
    <div className={homepageAboutWrap + ' ' + 'one'}>
        <div className={homepageAboutContent}>
          <p>We understand that choosing a child development program for your child can be a difficult decision. We hope that our 30 years of experience will help you to feel comfortable with your decision.</p>
