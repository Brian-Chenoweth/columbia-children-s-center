  ...
  return (
    <Layout pageTitle="Philosophy &amp; Goals" metaDesc="We believe that children have the right to a nurturing, safe environment where they can feel comfortable and secure.">
        ...
        <ul className={grid2}>
            ...
            <li>To teach respect for oneself and others</li>
            <li>To provide security</li>
            <li>To prepare the child for Kindergarten</li>
            <li>To teach responsibility</li>
        </ul>
    </Layout>
  )
}

export default PhilosophyGoalsPage