...
const OurTeamPage = () => {
  const employeeData = [
    ...
    { name: "Aniesa", title: "Early Year's Teacher Assistant", img: "Aniesa" },
    ...
    { name: "Michelle", title: "Preschool Teacher Assistant", img: "Michelle" },
    { name: "Lexie", title: "Preschool Teacher Assistant", img: "Lexie" },
    { name: "Brigitte Ortiz-Tello", title: "Outdoor Classroom Teacher", img: "Brigitte" },
    { name: "Veronica", title: "Outdoor Teacher Assistant", img: "Veronica" },
