...
const CareersPage = () => {
  return (
    <Layout
      pageTitle="Careers"
      titleOverride="Preschool Careers in Santa Maria, CA | Columbia Children's Center"
    ...
    >
      ...
      <a href="https://forms.gle/n3NMpdkQaw6P8RPR6" target="_blank" rel="noreferrer" className={button}>Apply Now</a>
